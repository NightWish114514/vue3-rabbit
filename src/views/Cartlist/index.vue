...
<template>
  <div class="xtx-cart-page">
    <div class="container m-top-20">
      <div class="cart">
        <table>
          <thead>
            <tr>
              <th width="120">
                <el-checkbox :model-value="cartStore.isAllCheck" @change="(selected:boolean) => allCheck(selected)" />
              </th>
      ...
      <div class="action">
        <div class="batch">
          共 {{cartStore.totalCount}} 件商品，已选择 {{cartStore.selectedTotalCount}} 件，商品合计：
