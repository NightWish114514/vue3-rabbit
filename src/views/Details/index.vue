...
import { getDetailAPI } from '@/apis/details';
import { ref, onMounted, watch } from 'vue';
import { useRoute } from 'vue-router';
import type { DetailDataType } from '@/types/details';
import DetailsHot from './component/DetailsHot.vue';
import ImageViews from '@/components/ImageViews/index.vue';
import XtxGoodSku from '@/components/XtxSku/index.vue';
import { useCartStore } from '@/store/useCartStore';
import type { DetailSkuType } from '@/types/details';
...
// 监听sku变化
const skuObj = ref<DetailSkuType>({} as DetailSkuType)
const handleChange = (sku: DetailSkuType) => {
  // console.log(sku)
  skuObj.value = sku
      ...
      <div class="info-container">
        <div>
          <div class="goods-info">
            <div class="media">
              <!-- 图片预览区 -->
              <ImageViews :imageList="detail.mainPictures" />
              <!-- 统计数量 -->
            ...
            <div class="spec">
              ...
              <!-- sku组件 -->
              <XtxGoodSku :goods="detail" @change="handleChange"/>
              <!-- 数据组件 -->
              <el-input-number v-model="count" />
              <!-- 按钮组件 -->
              <div>
                <el-button size="large" class="btn" @click="addCartToCartStore">
                  加入购物车
                </el-button>
              </div>
            ...
            <div class="goods-article">
              ...
              <div class="goods-tabs">
                ...
                <div class="goods-detail">
                  ...
                  <!-- 图片 -->
                  <img v-for="img in detail.details?.pictures" :key="img" :src="img" alt="商品图片">
                </div>
              </div>
            </div>
            <!-- 24热榜+专题推荐 -->
